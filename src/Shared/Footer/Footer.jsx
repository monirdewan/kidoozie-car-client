  ...
  return (
    <footer className="footer p-10 bg-base-200 text-base-content">
      ...
      <div>
        ...
        <a className="link link-hover flex items-center text-lg mb-2"><SlSocialFacebook className='mr-4 text-[#FF6799] text-2xl'/> Facebook</a>
        <a className="link link-hover flex items-center text-lg mb-2"><TbBrandTwitter className='mr-4 text-[#FF6799] text-2xl'/> Twitter</a>
        <a className="link link-hover flex items-center text-lg mb-2"><FaInstagram className='mr-4 text-[#FF6799] text-2xl'/>Instagram</a>
        <a className="link link-hover flex items-center text-lg mb-2"><CiYoutube className='mr-4 text-[#FF6799] text-2xl'/>Youtube</a>
